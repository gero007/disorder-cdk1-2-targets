...
holt_simple_NonCdk1_VAR <- var(Holt_data$predDisoPerc[Holt_data$target_all=="Non Cdk1 target"],na.rm = T)
holt_simple_Cdk1_VAR <- var(Holt_data$predDisoPerc[Holt_data$target_all=="Cdk1 target"],na.rm = T)
holt_simple_Cdk1_SD <- sd(Holt_data$predDisoPerc[Holt_data$target_all=="Cdk1 target"],na.rm = T)
holt_simple_NonCdk1_SD <- sd(Holt_data$predDisoPerc[Holt_data$target_all=="Non Cdk1 target"],na.rm = T)
holt_simple_test <- t.test(Holt_data$predDisoPerc[Holt_data$target_all=="Cdk1 target"],Holt_data$predSpotDisoPerc[Holt_data$target_all=="Non Cdk1 target"],var.equal=T)

holt_lite_NonCdk1_VAR <- var(Holt_data$predLiteDisoPerc[Holt_data$target_all=="Non Cdk1 target"],na.rm = T)
holt_lite_Cdk1_VAR <- var(Holt_data$predLiteDisoPerc[Holt_data$target_all=="Cdk1 target"],na.rm = T)
holt_lite_Cdk1_SD <- sd(Holt_data$predLiteDisoPerc[Holt_data$target_all=="Cdk1 target"],na.rm = T)
holt_lite_NonCdk1_SD <- sd(Holt_data$predLiteDisoPerc[Holt_data$target_all=="Non Cdk1 target"],na.rm = T)
holt_lite_test <- t.test(Holt_data$predLiteDisoPerc[Holt_data$target_all=="Cdk1 target"],Holt_data$predSpotDisoPerc[Holt_data$target_all=="Non Cdk1 target"],var.equal=T)

holt_spot_NonCdk1_VAR <- var(Holt_data$predSpotDisoPerc[Holt_data$target_all=="Non Cdk1 target"])
holt_spot_Cdk1_VAR <- var(Holt_data$predSpotDisoPerc[Holt_data$target_all=="Cdk1 target"],na.rm = T)
holt_spot_Cdk1_SD <- sd(Holt_data$predSpotDisoPerc[Holt_data$target_all=="Cdk1 target"],na.rm = T)
holt_spot_NonCdk1_SD <- sd(Holt_data$predSpotDisoPerc[Holt_data$target_all=="Non Cdk1 target"],na.rm = T)
holt_spot_test <- t.test(Holt_data$predSpotDisoPerc[Holt_data$target_all=="Cdk1 target"],Holt_data$predSpotDisoPerc[Holt_data$target_all=="Non Cdk1 target"],var.equal=T)
```