...
```{r cpomposition ,echo=FALSE,message=FALSE,warning=FALSE,fig.height=10}
...
fisherLiteDF$logPvalue <- -log10(fisherLiteDF$pvalue)
...
set.seed(1234)
fisherLiteDF$logPvalue[fisherLiteDF$logPvalue==0]<- 0.1
fisherLiteDF$logPvalue[fisherLiteDF$logPvalue==0.1]<-abs(jitter(fisherLiteDF$logPvalue[fisherLiteDF$logPvalue==0.1],6))

ggplot(fisherLiteDF, aes(x = logOr, y = logPvalue)) +
