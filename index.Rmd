...
The lack of correlation in this metric for different methods does not directly implies that the methods are not identifying the same regions. Detection of IDRs of different sizes by different methods or disparities in the lenghts of the disorder streaches could lead to the observed effects.  
