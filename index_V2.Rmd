...
human_data <- read_delim("PSP/human_data_curated_V2.tab", 
...
aurk_data <- read_delim("PSP/AURK/PSP_AURK_Target_HS.tab", 
...
human_data<-merge.data.frame(human_data, aurk_data, by = c("GENE","PROTEIN","ACC#"),all.x = T)
...
predictorsFisher_data<-as.data.frame(rbind(yeastIntersect_Fisher_data,human_Fisher_data,human_MAPK_Fisher_data,xenopus_Fisher_data))
