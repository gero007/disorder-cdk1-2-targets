...
iupl_upper_tri <- get_upper_tri(iupl_dunnnMat_ord)
...
spot_upper_tri <- get_upper_tri(spot_dunnnMat_ord)
# Melt the correlation matrix
...
vsl_upper_tri <- get_upper_tri(vsl_dunnnMat_ord)
# Melt the correlation matrix
...
# Understand the lower quartile of the disorder percentage
